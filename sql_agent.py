...
def create_schema_documents(db):
   ...
   table_descriptions = {
       ...
       "products": "Product catalog with product names, categories (Elecronics, Furniture, Accessories), and prices.  Use this for queries about items, merchandise, inventory, or what is being sold.",
